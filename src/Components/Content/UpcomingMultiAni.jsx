...
const UpcomingMultiAni = () => {
  ...
  const fetchUpcoming = async (pageNum) => {
    try {
      ...
      const formatted = filtered.map((anime) => ({
        id: anime.id,
      ...
      setError("Failed to load upcoming anime. Please try again.");
      console.error(err);
    } finally {
  ...
  return (
    <div className="px-5 pt-8 pb-12">
      <h1 className="text-3xl font-bold text-white mb-8">Upcoming Anime</h1>
...
export default UpcomingMultiAni;
